...
$sql = "SELECT posts.id_post, posts.photo AS post_photo, posts.tresc, users.nick, users.photo AS user_photo FROM posts JOIN users ON posts.id_uzyt = users.id ORDER BY posts.id_post DESC";
        ...
        echo "<div class='poscik'>";
            echo "<div class='content'>";
                echo "<div class='us'>";
                    ...
                    echo "<h3 class='usernam'><a href='user_profile.php?nazw=" . urlencode($post["nick"]) . "'>" . htmlspecialchars($post["nick"]) . "</a></h3>";
                echo "</div>";
